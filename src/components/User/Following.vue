  ...
  <div>
    <div class="card border-0 g-mb-15">
      ...
      <div class="card-header d-flex align-items-center justify-content-between g-bg-gray-light-v5 border-0 g-mb-15">
        <h3 class="h6 mb-0">
          <i class="icon-people g-pos-rel g-top-1 g-mr-5"></i> {{ user.name || user.username }} 关注的 <small v-if="followeds">(共 {{ followeds._meta.total_items }} 个, {{ followeds._meta.total_pages }} 页)</small>
        </h3>
